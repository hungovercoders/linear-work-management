...
| **Unclassified** | An issue on neither path — invisible work, the defect the system chases. |
...
| **Additive-only** | Teams may *add* to shared states/labels, never remove or rename them — cross-team views stay honest. |
| **Health** | On track · at risk · off track — always a **claim with evidence** (KR movement, issue progress), never just a colour. [Communications](communications.md). |
