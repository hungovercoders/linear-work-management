...
## What's broken?
<the fault, in one or two lines>

## Steps to reproduce
<the smallest sequence that triggers it>

## Expected vs actual
<what should happen, and what happens instead>

## Impact
<who or what it affects, and how badly — this is the "why now">

## Context
<environment, recent changes, related reports — any notes that don't fit above>

## Plan
<!-- LEFT EMPTY AT CREATION. The reserved home for the fix approach; filled later, when the
     issue is PICKED UP, so it's reviewable before the code is. -->
